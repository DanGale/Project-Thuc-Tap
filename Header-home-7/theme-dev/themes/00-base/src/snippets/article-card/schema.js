const articleCardSchema = (
  ...
  defaultData = {
    ...
    article_card_show_author: false,
  ...
  return [
    ...
    },
    {
      ...
      default: defaultData.article_card_show_author,
      label: `t:sections.${secHandle}.article_card_show_author.label`,
    },
    {
      type: 'checkbox',
...
module.exports = { articleCardSchema };
